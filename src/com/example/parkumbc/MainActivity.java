...
//                        calculateClosest();
                    ...
                    GoogleMap map1 = ((MapFragment) getFragmentManager()
                    		.findFragmentById(R.id.map)).getMap();
            		...
            		if (threshold <= 5) {
	            		...
	            		map1.addMarker(new MarkerOptions()
		            		.position(new LatLng(39.254266667, -76.707533333))
		            		.title("Transit").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_RED)));
            		}
                } else {
